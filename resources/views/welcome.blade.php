...
<head>
    ...
    <title>Portal Berita — Terpercaya, Terkini, Terdepan</title>
    <meta name="description" content="Portal Berita terkini dan terpercaya menyajikan berita utama, artikel mendalam, dan informasi terdepan dari berbagai kategori." />
        ...
        <div class="container">
            <nav class="navbar">
                <a href="{{ route('home') }}" class="navbar-brand">
                    ...
                    <h1 class="brand-name">Portal Berita</h1>
                </a>
